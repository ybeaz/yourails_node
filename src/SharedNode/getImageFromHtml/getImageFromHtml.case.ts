...
export const getImageFromHtmlCases: GetImageFromHtmlCaseType[] = [
  ...
  //     pathFileAbs: join(__dirname, '__output__', `t-${dateString}-image.png`),
  //     width: ImageSizesStandardEnum.LANDSCAPE_WIDTH, // Redefined in getImageFromHtml.run.ts
  //     height: ImageSizesStandardEnum.LANDSCAPE_HEIGHT, // Redefined in getImageFromHtml.run.ts
  //     scale: 2,
  //     scalingMode: ScalingModeEnum.deviceScaleFactor,
  //   },
  //   options: {
